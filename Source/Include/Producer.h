...
namespace AliceDB{
     ...
     * this could represent wrapper around kafka source, network socket, or simple file
    */
    ...
    public:
         ...
         * @return true if storage was set, false if there were no new values at the current moment
        */
    ...
    public:
        ...
        FileProducer(const std::string &filename, std::function<bool(std::string, Tuple<Type>*)>produce)
    ...
    private:
         ...
         * - std::istringstream with operator>> if Type fields are individually readable.
